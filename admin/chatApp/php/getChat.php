...
// get message query
$getMsgQuery = "SELECT * FROM `messages` LEFT JOIN `admin` ON messages.outgoing = admin.id WHERE outgoing = '{$outgoingid}' AND incoming = '{$incomingid}' OR outgoing = '{$incomingid}' AND incoming = '{$outgoingid}'";
