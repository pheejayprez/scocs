...
?>
				<tr>
					<td><?php echo $cnt;?></td>
					<td class="cart-image">
						<a data-lightbox="image-1" class="entry-thumbnail" href="admin/productimages/<?php echo htmlentities($row['opid']);?>/<?php echo htmlentities($row['pimg1']);?>">
...
<tr>
	<td colspan="9"><div class="cart-checkout-btn pull-right">
							<button type="submit" name="ordersubmit" class="btn btn-primary"><a href="payment-method.php" style="color:white">Proceed to Payment</a></button>
